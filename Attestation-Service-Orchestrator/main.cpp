...
void start(const string_t &address, const bool verbose) {
    uri_builder uri(address);
    auto addr = uri.to_uri().to_string();
    httpHandler = std::unique_ptr<handler>(new handler(addr, verbose));
...
static void printUsage(void) {
    printf("\n");
    printf("Centralized Attestation Service\n");
    printf("\n");
